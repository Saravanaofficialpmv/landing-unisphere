      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl md:text-5xl font-extrabold text-content-primary tracking-tight">
            Designed to solve real university complexity.
          </h2>
          <p className="mt-4 text-base sm:text-lg text-content-secondary font-normal">
            Traditional campus management tools create silos. Unisphere unifies operations through clean, purpose-built workflows.
          </p>
        </div>

        {/* 3 Large Minimal Cards */}
          ...
          {WHY_UNISPHERE_DATA.map((item, idx) => {
            ...
            return (
              <motion.div
                ...
                className="p-8 sm:p-10 rounded-3xl bg-surface-soft border border-border hover:border-primary/40 shadow-card hover:shadow-card-hover transition-all duration-300 flex flex-col justify-between relative group"
              >
                <div>
                  {/* Oversized Number + Icon */}
                  <div className="flex items-center justify-between mb-8">
                    ...
                    <div className="w-12 h-12 rounded-2xl bg-white border border-border flex items-center justify-center text-primary group-hover:scale-110 shadow-xs transition-transform">
                  ...
                  <p className="mt-3 text-base text-content-secondary leading-relaxed font-medium">
                    {item.description}
                  </p>
                  ...
                  <div className="mt-8 space-y-3 pt-6 border-t border-border/80">
                    {item.bullets.map((bullet, bIdx) => (
                      <div key={bIdx} className="flex items-start gap-2.5">
                        ...
                        <span className="text-xs sm:text-sm text-content-primary font-medium">
                          {bullet}
                        </span>
                      </div>
                    ))}
